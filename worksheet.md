...
- For this project, you're going to need a sprite and a background. You can download a zip file containing all the game assets by right-clicking [here]() and choosing to download the file.
